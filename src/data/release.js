...
const antd_province = CreateObj(province);
...
const city = {
	...
	'黑龙江省':['哈尔滨市','鸡西市','鹤岗市','双鸭山市','大庆市','伊春市','佳木斯市','七台河市','牡丹江市','黑河市','绥化市','大兴安岭地区'],
	'上海市':['上海市'],
	...
	'湖北省':['武汉市','黄石市','十堰市','宜昌市','襄阳市','鄂州市','荆门市','孝感市','荆州市','黄冈市','咸宁市','随州市','恩施土家族苗族自治州','直辖行政单位'],
...
//console.log(areaArray,city);

export { tab,areaArray,province,antd_province,city }