...
class Personal extends Component {
    constructor(props){
        ...
        let condition = {
            parentId:localStorage.signInfo?(JSON.parse(localStorage.signInfo).id == 0?"0":JSON.parse(localStorage.signInfo).id):''
        };
        this.state = {
            data:null,
            DATA,
    ...
    ck1 = (s) => {
        window.localStorage.parentId = s;
        console.log("s",s);
        this.props.history.push("/my_off2");
    };
